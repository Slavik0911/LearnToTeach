...
exports.generateLessonPreview = (0, https_1.onCall)({
    ...
    console.log("generateLessonPreview called");
    ...
    try {
        ...
        const imageBase64 = await (0, aiImage_service_1.generateLessonImageBase64)(prompt);
        const uploadResult = await (0, cloudinary_service_1.uploadLessonPreviewImage)(imageBase64);
        return {
