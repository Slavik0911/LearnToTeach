    ...
    <div className="flex flex-col gap-3 sm:gap-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <button
          ...
          className={selectButton(form.age === "Children", errors.age && form.age === "")}
        >
          Children
        </button>
        <button
          ...
          className={selectButton(form.age === "Adult", errors.age && form.age === "")}
        >
          Adult
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 sm:gap-4">
        {LEVELS.map((level) => (
          <button
            ...
            className={levelButton(form.level === level, errors.level && form.level === "")}
          >
            {level}
          </button>
        ))}
      ...
      {form.lessonType === "grammar" && (
        <div className="flex flex-col gap-3">
          <input
            ...
            onChange={(e) => setField("grammarTopic", e.target.value)}
            type="text"
          ...
          <input
            ...
            onChange={(e) => setField("exercisesCount", e.target.value)}
            type="text"
      ...
      <div className="mt-2 pt-4 border-t border-gray-200">
        ...
        <div className="flex flex-col gap-2 sm:gap-3">
          <input
            ...
            onChange={(e) => setField("studentVersion", e.target.value)}
            type="text"
          ...
          <input
            ...
            onChange={(e) => setField("teacherVersion", e.target.value)}
            type="text"
          ...
          <input
            ...
            onChange={(e) => setField("worksheetsUrl", e.target.value)}
            type="text"
