...
export default function LessonCard({ level, topic, description, saved, slug }) {
  ...
  return (
    ...
    <NavLink
      to={`/lessons/${slug}`}
      className={`block border border-gray-300 rounded-lg p-3 hover:shadow-lg transition flex flex-col min-h-[320px] max-w-[320px] ${bgClass}`}>
