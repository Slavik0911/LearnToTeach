    ...
    return (
        <Link to={route} className={base} onContextMenu={onContextMenu}>
            <div className="h-full flex flex-col items-center justify-center p-3 sm:p-4 text-center">
                <h3 className="text-2xl sm:text-2xl md:text-3xl leading-tight">
                    {title}
                </h3>
                <div className="text-4xl sm:text-4xl md:text-5xl my-2 sm:my-3 md:my-4">
                    {value}
                </div>
                {note !== "" && (
                    <p className="text-base sm:text-xl md:text-2xl opacity-80">
                        *{note}
                    </p>
                )}
            </div>
