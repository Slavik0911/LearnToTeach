        ...
        <div className="space-y-10">
            <div className="mx-auto grid max-w-[90rem] grid-cols-1 items-start gap-10 lg:grid-cols-2">
                <div className="space-y-4">
                    ...
                    <p className="text-xl">
                        Our site offers a variety of ready-made lesson plans,
                        speaking activities, and grammar games that are not only
                        effective but also fun for A1-C1 students. With our
                        materials, you can focus on what matters most - teaching
                        your students. Explore our site now and discover how we
                        can help enhance your teaching experience!
                    </p>
                </div>
